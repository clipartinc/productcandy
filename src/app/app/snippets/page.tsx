...
const TWO_COL_INSERT = `<div style="display:flex;gap:16px;width:100%;"><div style="flex:1;min-width:0;"><h3>Column 1 heading</h3><p>Add column 1 text here.</p></div><div style="flex:1;min-width:0;"><h3>Column 2 heading</h3><p>Add column 2 text here.</p></div></div><p></p>`;

const THREE_COL_INSERT = `<div style="display:flex;gap:16px;width:100%;"><div style="flex:1;min-width:0;"><h3>Column 1</h3><p>Add text.</p></div><div style="flex:1;min-width:0;"><h3>Column 2</h3><p>Add text.</p></div><div style="flex:1;min-width:0;"><h3>Column 3</h3><p>Add text.</p></div></div><p></p>`;
