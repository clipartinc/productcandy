...
const TWO_COL_INSERT = `${RESPONSIVE_STYLE}<div class="pc-snippet-wrap" style="container-type:inline-size;width:100%;"><div class="pc-snippet-row" style="display:grid !important;grid-template-columns:repeat(2, minmax(0, 1fr));gap:16px;width:100%;align-items:start;box-sizing:border-box;"><div class="pc-snippet-col" style="min-width:0;box-sizing:border-box;"><h3>Column 1 heading</h3><p>Add column 1 text here.</p></div><div class="pc-snippet-col" style="min-width:0;box-sizing:border-box;"><h3>Column 2 heading</h3><p>Add column 2 text here.</p></div></div></div><p></p>`;

const THREE_COL_INSERT = `${RESPONSIVE_STYLE}<div class="pc-snippet-wrap" style="container-type:inline-size;width:100%;"><div class="pc-snippet-row" style="display:grid !important;grid-template-columns:repeat(3, minmax(0, 1fr));gap:16px;width:100%;align-items:start;box-sizing:border-box;"><div class="pc-snippet-col" style="min-width:0;box-sizing:border-box;"><h3>Column 1</h3><p>Add text.</p></div><div class="pc-snippet-col" style="min-width:0;box-sizing:border-box;"><h3>Column 2</h3><p>Add text.</p></div><div class="pc-snippet-col" style="min-width:0;box-sizing:border-box;"><h3>Column 3</h3><p>Add text.</p></div></div></div><p></p>`;
