...
${RESPONSIVE_STYLE}
${WRAP_OPEN}
<div class="pc-snippet-row" data-pc-template="two-column" style="display:flex;gap:16px;width:100%;min-width:100%;align-self:stretch;box-sizing:border-box;">
  <div class="pc-snippet-col" style="flex:1 1 0;min-width:0;">
...
${RESPONSIVE_STYLE}
${WRAP_OPEN}
<div class="pc-snippet-row" data-pc-template="three-column" style="display:flex;gap:16px;width:100%;min-width:100%;align-self:stretch;box-sizing:border-box;">
  <div class="pc-snippet-col" style="flex:1 1 0;min-width:0;">
    <h3>${phInline("Column 1 heading", bg, text)}</h3>
...
${RESPONSIVE_STYLE}
${WRAP_OPEN}
<div class="pc-snippet-row" data-pc-template="image-text" style="display:flex;gap:16px;width:100%;min-width:100%;align-self:stretch;box-sizing:border-box;align-items:flex-start;">
  <div class="pc-snippet-col" style="flex:1 1 0;min-width:0;">${ph("Image placeholder — replace with a product image using Shopify's image button in the description editor.", bg, text)}</div>
  <div class="pc-snippet-col" style="flex:1 1 0;min-width:0;">
...
${RESPONSIVE_STYLE}
${WRAP_OPEN}
<div class="pc-snippet-row" data-pc-template="text-image" style="display:flex;gap:16px;width:100%;min-width:100%;align-self:stretch;box-sizing:border-box;align-items:flex-start;">
  <div class="pc-snippet-col" style="flex:1 1 0;min-width:0;">
    <h3>${phInline("Headline", bg, text)}</h3>
    ${ph("Click here to write your supporting text…", bg, text)}
  </div>
...
${RESPONSIVE_STYLE}
${WRAP_OPEN}
<div class="pc-snippet-row" data-pc-template="gallery-3" style="display:flex;gap:16px;">
  <div class="pc-snippet-col" style="flex:1 1 0;min-width:0;">
