...
${RESPONSIVE_STYLE}
${WRAP_OPEN}
<div class="pc-snippet-row" data-pc-template="two-column" style="display:grid !important;grid-template-columns:repeat(2, minmax(0, 1fr));gap:16px;width:100%;align-items:start;box-sizing:border-box;">
...
${RESPONSIVE_STYLE}
${WRAP_OPEN}
<div class="pc-snippet-row" data-pc-template="three-column" style="display:grid !important;grid-template-columns:repeat(3, minmax(0, 1fr));gap:16px;width:100%;align-items:start;box-sizing:border-box;">
  <div class="pc-snippet-col" style="min-width:0;box-sizing:border-box;">
    <h3>${phInline("Column 1 heading", bg, text)}</h3>
...
${RESPONSIVE_STYLE}
${WRAP_OPEN}
<div class="pc-snippet-row" data-pc-template="image-text" style="display:grid !important;grid-template-columns:repeat(2, minmax(0, 1fr));gap:16px;width:100%;align-items:start;box-sizing:border-box;">
...
${RESPONSIVE_STYLE}
${WRAP_OPEN}
<div class="pc-snippet-row" data-pc-template="text-image" style="display:grid !important;grid-template-columns:repeat(2, minmax(0, 1fr));gap:16px;width:100%;align-items:start;box-sizing:border-box;">
  <div class="pc-snippet-col" style="min-width:0;box-sizing:border-box;">
    <h3>${phInline("Headline", bg, text)}</h3>
    ${ph("Click here to write your supporting text…", bg, text)}
  </div>
...
${RESPONSIVE_STYLE}
${WRAP_OPEN}
<div class="pc-snippet-row" data-pc-template="gallery-3" style="display:grid !important;grid-template-columns:repeat(3, minmax(0, 1fr));gap:16px;width:100%;align-items:start;box-sizing:border-box;">
  <div class="pc-snippet-col" style="min-width:0;box-sizing:border-box;">
